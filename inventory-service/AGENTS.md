...
Scope: inventory-service/. Also follow the repository-root AGENTS.md.

Uses JPA/MySQL and Flyway. Preserve stock lookup semantics, repository queries, schema migrations, and the HTTP contract consumed by order-service. Existing tests include MySQL Testcontainers and RestAssured.
